...
# ============================================================
# USGS TOPOGRAPHIC NATIONAL PARK MAP
# ============================================================

def park_map(map_df):
    """
    Build an interactive Folium map using USGS National Map tiles.
    ...
    for _, row in map_df.iterrows():
        ...
        # Scale marker size relative to largest park
        radius = (
            6
            + math.sqrt(
                records / max_records
...
with st.container(
    ...
    card_title(
        "Park locations",
        "Interactive USGS topographic map",
    )
